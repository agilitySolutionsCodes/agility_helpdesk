<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manutencao.aspx.cs" Inherits="BOffice.Classificacoes.Manutencao" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title><%: Page.Title %>- Manutenção de Classificações Gerenciador de Conteúdo </title>
            ...
            <table width="970" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="950"><a href="Home">Home</a>&nbsp;>>&nbsp;
                                    <a href="Selecionar-Classificacoes-Cadastro">Selecionar tipo de cadastro de classificação</a>
                        &nbsp;>>&nbsp; Manutenção de classificações</td>
                </tr>
            </table>
        </div>
        <div id="form_box3">
            <asp:Label ID="LblMsgmChamados" runat="server" Visible="false" Style="font-family: Verdana, Geneva, sans-serif; font-size: 12px;" />
            <asp:GridView ID="GrdClassificacoes" runat="server" CssClass="border_table" AutoGenerateColumns="False"
                RowStyle-HorizontalAlign="NotSet" AllowPaging="True" OnRowDeleting="GrdClassificacoes_RowDeleting"
                OnPageIndexChanging="GrdClassificacoes_PageIndexChanging" PageSize="10" PagerStyle-CssClass="paginacao"
                meta:resourcekey="GrdClassificacoesResource1">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Ações" meta:resourcekey="TemplateFieldResource1">
                        <ItemTemplate>
                            <asp:ImageButton runat="server" ID="BtnDeletar" OnClick="BtnDeletar_Click" OnClientClick="javascript:return confirm('Deseja excluir este registro?');"
                                CausesValidation="False" CommandName="Deletar" CommandArgument='<%# Bind("IdClassificacao") %>'
                    ...
                    <asp:TemplateField HeaderText="Código" Visible="true" meta:resourcekey="TemplateFieldResource2">
                        <ItemTemplate>
                            <asp:Label ID="lblIdClassificacao" runat="server" Text='<%# Bind("IdClassificacao") %>' meta:resourcekey="lblIdUsuarioResource1" />
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" CssClass="header_table" />
                    </asp:TemplateField>
