<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Fila.aspx.cs" Inherits="Site.Paginas.Chamados.Fila" %>
<%@ Register Assembly="System.Web.DataVisualization, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35" Namespace="System.Web.UI.DataVisualization.Charting" TagPrefix="asp" %>

<asp:Content ID="ContentHead" ContentPlaceHolderID="HeadContent" runat="server">
    <title><%: Page.Title %>-Fila de Chamados Web Help-Desk</title>
    <meta name="description" content="Fila de chamados sistema Web Help-Desk Agility Solutions" />
</asp:Content>
