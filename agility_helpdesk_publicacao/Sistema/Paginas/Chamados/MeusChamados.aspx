<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MeusChamados.aspx.cs" Inherits="Site.Paginas.Chamados.MeusChamados" %>

<asp:Content ID="ContentHead" ContentPlaceHolderID="HeadContent" runat="server">
    <title><%: Page.Title %>-Meus Chamados Web Help-Desk</title>
    <meta name="description" content="Meus chamados Web Help-Desk Agility Solutions" />
</asp:Content>
...
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContent" runat="server">
    <div id="right_side">
        ...
        <asp:GridView ID="GrdChamados" runat="server" CssClass="border_table" AutoGenerateColumns="False"
            RowStyle-HorizontalAlign="NotSet" OnRowDeleting="GrdChamados_RowDeleting"
            OnPageIndexChanging="GrdChamados_PageIndexChanging" PageSize="10" AllowPaging="true" AllowSorting="true" OnSorting="GridView_Sorting"
            meta:resourcekey="GrdChamadosResource1" PagerStyle-CssClass="paginacao">
            ...
            <Columns>
                <asp:TemplateField HeaderText="Número" Visible="true" ControlStyle-Width="50px" meta:resourcekey="TemplateFieldResource2">
                    <ItemTemplate>
                        <a class="lbllink" href='<%#"Chamados-Detalhe?IdChamado="+ DataBinder.Eval(Container.DataItem,"Codigo") %>'>
